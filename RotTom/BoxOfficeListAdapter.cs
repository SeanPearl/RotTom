...
namespace RotTom
{
	...
	public class BoxOfficeListAdapter : BaseAdapter<Movie>
	{
		...
		public BoxOfficeListAdapter(Activity context, List<Movie> movies) : base()
		{
		...
		public override View GetView (int position, View convertView, ViewGroup parent)
		{
			...
			if (view == null) // otherwise create a new one
				view = context.LayoutInflater.Inflate(Resource.Layout.BoxOfficeItem, null);
			...
			//view.FindViewById<TextView>(Resource.Id.boxOfficeAmount).Text = (movies[position].);
